...
export default function WelcomeSectionView({ welcomeSection, siteLabels, isAdmin, onEditSection, activeSectionId }: WelcomeSectionViewProps) {
 ...
 <div className="relative w-screen left-1/2 -translate-x-1/2 -mt-10 md:-mt-14 border-b border-stone-200/80 bg-neutral-950 overflow-hidden h-[320px] sm:h-[400px] md:h-[480px] transition-all duration-500">
 <img
 ...
 <div className="mx-auto max-w-7xl px-4 md:px-6 w-full pb-8 text-white space-y-2 z-10 drop-shadow-none">
